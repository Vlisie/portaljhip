...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './adres.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADRES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADRES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADRES actions', async () => {
      const expectedActions = [
        {
